...
impl<'info> IxOps<'info> for PostSignatures {
    ...
    fn get_data(
        ...
        let signatures = crate::quardian_set_5_mock::SIGNATURES.to_vec();
        let signatures_len = crate::quardian_set_5_mock::SIGNATURES.len();

        let data = solana_world_id_program::instruction::PostSignatures {
            guardian_signatures: signatures,
            total_signatures: signatures_len as u8,
        };
