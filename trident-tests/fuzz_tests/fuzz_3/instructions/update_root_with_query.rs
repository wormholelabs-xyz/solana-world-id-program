...
impl<'info> IxOps<'info> for UpdateRootWithQuery {
    ...
    fn get_data(
        ...
        let data = solana_world_id_program::instruction::UpdateRootWithQuery {
            bytes: crate::guardian_set_9_mock_nineteen_guardians::BYTES.into(),
            root_hash: crate::guardian_set_9_mock_nineteen_guardians::ROOT_HASH,
            guardian_set_index:
                crate::guardian_set_9_mock_nineteen_guardians::NINETEEN_MOCK_GUARDIAN_SET_INDEX,
        };
        Ok(data)
    }
    fn get_accounts(
